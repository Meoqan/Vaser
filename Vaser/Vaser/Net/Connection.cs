    ...
    internal class Connection
    {
        ...
        private void ReceiveNotEncryptedCallback(IAsyncResult iar)
        {
            ...
            lock (_ReceiveDisposelock)
            {
                if (StreamIsConnected)
                {
                    //Console.WriteLine("YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY");
                    ...
                    //Console.WriteLine("OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO");
                }
            }
