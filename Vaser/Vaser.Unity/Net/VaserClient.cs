    ...
    public class VaserClient
    {
        ...
        public static Link ConnectClient(string IP, int RemotePort, PortalCollection PColl)
        {
            ...
            try
            {
                ...
                {
                    PColl._Active = true;
                    Connection con = new Connection(client, false, VaserOptions.ModeNotEncrypted, PColl, null, null);
        ...
        public static Link ConnectClient(string IP, int RemotePort, PortalCollection PColl, VaserSSLClient SSL)
        {
            ...
            try
            {
                ...
                {
                    PColl._Active = true;
                    Connection con = new Connection(client, false, VaserOptions.ModeSSL, PColl, null, SSL);
